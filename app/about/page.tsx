        ...
        <div className="relative z-10 flex min-h-[620px] sm:min-h-[720px] items-center justify-center px-4 py-20 sm:px-6">
          <div className="mx-auto w-full max-w-5xl text-center">
            ...
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link
                href="/clans"
                className="inline-flex min-h-[46px] w-full items-center justify-center rounded-full bg-amber-600 px-7 text-sm font-semibold text-white shadow-lg transition hover:bg-amber-700 hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-amber-300 focus:ring-offset-2 focus:ring-offset-transparent sm:w-auto sm:text-base"
              >
                Explore Clans
              ...
              <Link
                href="/contribute"
                className="inline-flex min-h-[46px] w-full items-center justify-center rounded-full border border-white/30 bg-white/10 px-7 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/20 hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-amber-300 focus:ring-offset-2 focus:ring-offset-transparent sm:w-auto sm:text-base"
              >
                Contribute
              </Link>
            </div>
