...
const getTribeBackground = (tribeName: string): string => {
  const bgMap: Record<string, string> = {
    Zulu: "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/tribe-bg/zulu1.png",
    Xhosa: "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/tribe-bg/xhosa1.png",
    Swati: "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/tribe-bg/swati1.png",
    Ndebele: "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/tribe-bg/ndebele1.png",
    Sotho: "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/tribe-bg/sotho1.png",
    Tswana: "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/tribe-bg/tswana1.png",
    Venda: "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/tribe-bg/venda1.png",
    Tsonga: "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/tribe-bg/tsonga1.png",
    Pedi: "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/tribe-bg/pedi1.png",
  };
  return bgMap[tribeName] || "https://res.cloudinary.com/dwxp1yq4b/image/upload/v1779383915/Tribe2.png";
};
...
export default function TribeDetailPage() {
  ...
  useEffect(() => {
    async function fetchTribeData() {
      ...
      try {
        setLoading(true);
        const res = await fetch(`/api/tribes/${tribeName}`);
