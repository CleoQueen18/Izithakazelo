    ...
    <div className="bg-[#faf7f2] text-gray-800">
      ...
      <section className="relative h-[60vh] sm:h-[85vh] min-h-[400px] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 h-full flex flex-col justify-center items-center text-center">
          ...
          {/* Alphabet - COMPLETE REDESIGN WITH FLEXBOX */}
          <div className="mt-6 sm:mt-8 w-full max-w-2xl px-2 sm:px-0">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-3 sm:p-4 border border-white/20">
              ...
              {/* Using flexbox with smaller max-width to guarantee no cutoff */}
              <div className="flex flex-wrap justify-center gap-1 sm:gap-1.5 max-w-[280px] xs:max-w-[320px] sm:max-w-sm mx-auto">
                {alphabet.map((letter) => (
                  <button
                    key={letter}
                    onClick={() => handleLetterClick(letter)}
                    className="w-7 h-7 xs:w-8 xs:h-8 sm:w-9 sm:h-9 rounded-full bg-white/20 hover:bg-amber-600 text-white font-medium transition-all duration-200 hover:scale-105 flex items-center justify-center text-[10px] xs:text-xs sm:text-sm flex-shrink-0"
                  >
                    {letter}
                  </button>
                ))}
                <button
                  ...
                  className="px-2 xs:px-3 h-7 xs:h-8 sm:h-9 rounded-full bg-white/20 hover:bg-amber-600 text-white font-medium transition-all duration-200 flex items-center justify-center text-[10px] xs:text-xs sm:text-sm flex-shrink-0"
                >
                  All
                </button>
              </div>
